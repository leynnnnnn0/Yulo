<div id="createPostContainer" class="hidden z-50 fixed h-full w-full flex justify-center items-center bg-primary/10">
    <form method="post" action="/post/add" class="flex flex-col bg-secondary h-96 w-[500px] rounded-xl border border-white/5 relative">
        @csrf
